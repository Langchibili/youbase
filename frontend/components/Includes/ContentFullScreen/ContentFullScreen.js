...
export default function ContentFullScreen(props) {
  ...
  // Renders the content (video or image) along with user avatar and engagement buttons.
      ...
      <div>
        ...
        <div
          ...
          style={{
            ...
            maxHeight: "100vh", // Ensures height won't exceed the viewport
            margin: "0 auto",
          }}
        >
          {props.post.type === "video" ? (
            <VideoPlayer
              autoPlayVideo={true}
              poster={getVideoThumbnail(props.file, props.post)}
              post={props.post}
              loggedInUser={props.loggedInUser}
              videoFormats={props.file.formats}
              originalVideoUrl={props.file.url}
              videoWrapperStyles={{
                width: window.innerWidth > 360 ? "360px" : "100%",
                margin: "0 auto",
                maxHeight: "100vh",
            ...
            <img
              style={{
                width: "100%",
                height: "auto",
                maxHeight: "100%", // Ensures the image doesn't exceed container height
                objectFit: "cover",
              }}
        ...
        >
          <ul style={{ listStyleType: "none", padding: 0 }}>
            <li style={{ display: "block", float: "left" }}>
              ...
              >
                {props.post.type === "video" ? (
                  <ViewsDisplay inFullScreen={true} {...props} user={user} />
                ) : null}
                {props.post.type === "music" ? (
                  <StreamsDisplay inFullScreen={true} {...props} user={user} />
                ) : null}
            ...
            <li style={{ width: "100%" }}>
              ...
              >
                <CommentsModal
                  ...
                  userId={props.loggedInUser.user.id}
                />
                <PostMoreModal {...props} />
              </div>
            </li>
