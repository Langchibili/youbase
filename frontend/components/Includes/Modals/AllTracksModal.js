...
import AllTracksDisplay from '../AllTracksDisplay/AllTracksDisplay';
  ...
  return (
    <Root style={{backgroundColor:'transparent'}}>
      ...
      <Button onClick={toggleDrawer(true)}>
        <Comment />Track List {commentCountLoaded? " "+handleCountsDisplay(commentsCount).toString() : <></>}
        </Button>
      <SwipeableDrawer
        container={container}
        anchor="bottom"
